/* StateProgramsSection.tsx — DiscountHub
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            {program.website && program.website !== "N/A" && program.website.startsWith("http") && (
              <a
                ...
                className="inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-lg border border-[oklch(0.55_0.13_42)] text-[oklch(0.45_0.13_42)] hover:bg-[oklch(0.93_0.04_42)] transition-colors"
              >
      ...
      {showZipFilter && (
        <div className="bg-[oklch(0.96_0.02_42)] rounded-xl border border-[oklch(0.88_0.04_42)] p-4">
          <div className="flex items-center gap-2 mb-3">
            <MapPin className="w-4 h-4 text-[oklch(0.55_0.13_42)]" />
