  ...
  return (
    <div className="min-h-screen flex flex-col bg-[oklch(0.98_0_0)]">
      ...
      {(showRegional || zipFilter.active) && (
        <div className="container py-8 border-t border-[oklch(0.90_0_0)]">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h2 className="font-['Playfair_Display'] text-2xl font-bold text-[oklch(0.15_0.04_175)]">
            ...
            {(zipFilter.active && zipFilter.stateCode
              ...
              <div key={p.id} className="bg-white rounded-xl border border-dashed border-[oklch(0.75_0.06_42)] p-4 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between gap-2 mb-2">
                  <h3 className="font-semibold text-sm text-[oklch(0.15_0.04_175)] leading-snug">{p.name}</h3>
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-[oklch(0.93_0_0)] text-[oklch(0.45_0.08_175)] shrink-0">
                ...
                <div className="flex gap-2">
                  {p.website && p.website.startsWith("http") && (
                    <a href={p.website} target="_blank" rel="noopener noreferrer"
                      className="text-xs font-semibold text-[oklch(0.45_0.08_175)] hover:underline flex items-center gap-1">
                      Visit Site
                    </a>
                  )}
                </div>
