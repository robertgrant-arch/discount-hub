          ...
          <div className="bg-[oklch(0.95_0.04_15)] rounded-xl border border-[oklch(0.85_0.06_15)] p-4 mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              <a
                ...
                className="inline-flex items-center gap-1.5 bg-[#C05824] hover:bg-[#a84b1e] text-white)] text-white font-semibold px-4 py-2 rounded-lg transition-colors text-xs"
              >
          ...
          <div className="container max-w-5xl">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="https://www.selectquote.com/medicare"
                target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-[#C05824] hover:bg-[#a84b1e] text-white)] text-white font-semibold px-6 py-3 rounded-lg transition-colors"
              >
              ...
              <div className="rounded-xl bg-[oklch(0.95_0.04_15)] border border-[oklch(0.85_0.06_15)] p-6 text-center">
                ...
                <div className="flex flex-wrap gap-3 justify-center">
                  <a
                    href="https://www.selectquote.com/medicare"
                    target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-[#C05824] hover:bg-[#a84b1e] text-white)] text-white font-semibold px-5 py-2.5 rounded-lg transition-colors text-sm"
                  >
